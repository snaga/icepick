...
(Generic environment variables like GEMINI_API_KEY
...
def format_actionable_error(key_name: str, app_prefix: str = "icepick") -> str:
    ...
    Args:
        key_name: Credential key identifier (e.g., 'gemini_api_key').
...
def resolve_credential(
    ...
    Priority Pyramid:
      ...
      (Generic ambient variables such as GEMINI_API_KEY
       are intentionally ignored to avoid accidental secret leak and ambient contamination.)

    Args:
        key_name: Logical credential key name (e.g. 'gemini_api_key').
